	...
	//	SOC_Write_Servicer(VIDEO_PASSAGE_ASTERN);
		flag_now_config_channal_AUX_or_Astren = 0;
		     if(signal_is_how[info_com_top_Channel].Format == NTSC_I)
		        {
		        Tw9912_image_global_AUX_BACK[0][1] = 0xff;//honda xiyu is 31 // is good 00
		        Tw9912_image_global_AUX_BACK[1][1] = 0x5a;//honda xiyu 5c //is good 58
			...
			// printk("Tw9912_image_global_AUX_BACK reset valu from NTSC_I\n");
		     	...
		     	{
		        Tw9912_image_global_AUX_BACK_PAL_I[0][1]= 0xff;// is good 00
		        Tw9912_image_global_AUX_BACK_PAL_I[1][1]= 0x5a;//is good 58
