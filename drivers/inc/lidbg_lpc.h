...
#define LPC_CMD_RADIO_SET  do{\
		u8 buff0[] = {0x0D, 0x00, 0x6F, 0x00, 0x00, 0x1D};\
		u8 buff1[] = {0x0D, 0x10, 0x2D, 0x00, 0x01, 0x98};\
        	u8 buff2[] = {0x0D, 0x10, 0x50, 0x08,0x00};\
        	u8 buff3[] = {0x0D, 0x10, 0x51, 0x02,0x63};\
        	u8 buff4[] = {0x0D, 0x10, 0x6D, 0x08, 0x00};\
