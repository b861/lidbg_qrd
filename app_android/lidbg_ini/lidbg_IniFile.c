...
#include "../lidbg_servicer/lidbg_servicer.h"

#include "lidbg_IniFile.h"
...
//	ini start
//  [10/18/2005]
int ini_start(const char *filename)
{
    init_content();
...
int load(const char *filename)
{
    ...
    if( (in_stream = fopen( filename, "r+" )) != NULL )//lsw
    {
...
U32 get_value_num(const char *sec, const char *key)
{
    char *str;
    U32 Temp;

    str = get_value(sec, key);

    Temp = ini_str2num(str);
...
// [10/20/2005]
int set_value(const char *sec, const char *key,  const char *value)
{
    return _set_value(sec, key, value, "", REPLACE);
}
//////////////////////////////////////////////////////////////////////////
// [10/20/2005]
int _set_value(const char *sec, const char *key,  const char *value, const char *comment, REPLACE_FLAG flag)
{
    w_flag = flag;
    error_msg = NULL;
