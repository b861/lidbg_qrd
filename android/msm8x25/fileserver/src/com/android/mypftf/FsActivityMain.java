 ...
 * 
 */
public class FsActivityMain extends Activity
{
	...
	private FsClassCommen mFsClassCommen;
	private Context fsContext;
	private FsClassOsd mFsClassOsd;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		fsPreferences = getSharedPreferences(PREFE_FILE_FS, 0);

		Log.e(TAG, "[futengfei].mainActivity.onCreate\n");

		fsContext = getApplicationContext();
		mFsClassCommen = new FsClassCommen(fsContext);
		mFsClassOsd = new FsClassOsd(fsContext);
		...
		OnLongClickListener buttoncommenClickListener = new OnLongClickListener()
		{
			...
			public boolean onLongClick(View v)
			{
				...
				} else if (v.equals(mjBupload_state))
				{
					...
					{
						send_msg("10086", "112");
						send_msg("10086", "cxchtuk");
						send_msg("10086", "10086");
					}
				}
				return false;
			}
	...
	private Boolean is_china_mobile()
	{
		// TODO Auto-generated method stub
		// 判断是否是中国移动网络
	...
	private void send_msg(String num, String context)
	{
		// TODO Auto-generated method stub
	...
	private void show_osd_dialog()
	{
		...
		final ImageView jved_osdiImageView = (ImageView) layout
				.findViewById(R.id.lo_iv_osd);
		...
		jvsb_osdsize.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
		{
					...
					boolean fromUser)
			{
				...
				if (mFsClassOsd.is_osd_enable())
				{
					...
					Log.e(TAG, "onProgressChanged:===OSDSIZE=====" + progress);
				}

			}
		});

		AlertDialog.Builder builder = new Builder(FsActivityMain.this);
	...
	private void show_more_dialog()
	{
		...
		ksmgpathEditText.setText("/data/lidbg_kmsg.txt");
		new AlertDialog.Builder(this).setTitle("功能未启用")
					...
					public void onClick(DialogInterface dialog, int which)
					{
						...
						if (ksmgpathEditText.length() > 0)
						{
							String kmsgString = ksmgpathEditText.getText()
									.toString();
							mFsClassCommen.show_toast("功能未启用：" + kmsgString);
						}
						dialog.dismiss();
					}
	...
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].kmsg_disable\n");
		mFsClassCommen.write_to_file(lidbg_node, cmd_string_kmsg_disable);
	}

	private void kmsg_enable()
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].kmsg_enable\n");
		mFsClassCommen.write_to_file(lidbg_node, cmd_string_kmsg_enable);
	}

	private void restart_myself()
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].restart_myself");
	...
	protected void onDestroy()
	{
		...
		mFsClassCommen.show_toast("【fileserver】: 已退出");
		super.onDestroy();
	}

	private void stop_state_file_thread()
	{
		Log.e(TAG, "[futengfei].stop_state_file_thread\n");
	...
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].creat_state_file_thread\n");
	...
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].update_sd_state\n");
	...
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].start to register_sd_broadcast");
	...
	{
		// TODO Auto-generated method stub
		Log.e(TAG, "[futengfei].onBackPressed");
		super.onBackPressed();
	}
	...
	private OnItemClickListener mylis_list = new OnItemClickListener()
	{
				...
				long arg3)
		{
					...
					&& (arg2 == data_txtfile_list_bias))
			{
				...
				mFsClassCommen.write_to_file(lidbg_node, cmd_string_chmod);
			...
			{
			case 0:
				mFsClassCommen.write_to_file(lidbg_node, cmd_string_destroy);
				break;
			case 1:
			...
			case 3:
				...
				intent_kmsg.setClass(FsActivityMain.this, FsActivityKmsg.class);
			...
			case 4:
...

				{
					...
					mFsClassCommen.write_to_file(lidbg_node, cmd_string_upload);
