...
public class PackageActivityMainGridViewAdapter extends BaseAdapter
{
	...
	public PackageActivityMainGridViewAdapter(Context context,
			String[] icons_name, int[] icons)
	{
		_con = context;
	...
	public View getView(int position, View convertvView, ViewGroup parent)
	{
		...
		View v = factoryInflater.inflate(R.layout.slide_grid, null);
