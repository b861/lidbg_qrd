...
****************************************************************************/
void  GUI_Rectangle(U32 x0, U32 y0, U32 x1, U32 y1, U32 color)
{
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_RectangleFill(U32 x0, U32 y0, U32 x1, U32 y1, U32 color)
{
    U32  i;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Square(U32 x0, U32 y0, U32  with, U32  color)
{
    if(with == 0) return;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Line(U32 x0, U32 y0, U32 x1, U32 y1, U32 color)
{
    int32   dx;						// 直线x轴差值变量
    int32   dy;          			// 直线y轴差值变量
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_LineWith(U32 x0, U32 y0, U32 x1, U32 y1, U8 with, U32 color)
{
    int32   dx;						// 直线x轴差值变量
    int32   dy;          			// 直线y轴差值变量
    int8    dx_sym;					// x轴增长方向，为-1时减值方向，为1时增值方向
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Circle(U32 x0, U32 y0, U32 r, U32 color)
{
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_CircleFill(U32 x0, U32 y0, U32 r, U32 color)
{
    int32  draw_x0, draw_y0;			// 刽图点坐标变量
    int32  draw_x1, draw_y1;
    int32  draw_x2, draw_y2;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Ellipse(U32 x0, U32 x1, U32 y0, U32 y1, U32 color)
{
    int32  draw_x0, draw_y0;			// 刽图点坐标变量
    int32  draw_x1, draw_y1;
    int32  draw_x2, draw_y2;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_EllipseFill(U32 x0, U32 x1, U32 y0, U32 y1, U32 color)
{
    int32  draw_x0, draw_y0;			// 刽图点坐标变量
    int32  draw_x1, draw_y1;
    int32  draw_x2, draw_y2;
...
* 说明：若没有找出，则返回最左的x坐标0。
****************************************************************************/
U32  GUI_ReadLeftPoint(U32 x0, U32 y0, U32 color)
{
    U32  i;
    U32  bakc;
...
****************************************************************************/
U32  GUI_ReadRightPoint(U32 x0, U32 y0, U32 color)
{
    U32  i;
    U32  bakc;
...
* 说明：
****************************************************************************/
int  GUI_CmpPoinU32(U32 x, U32 y, U32 color)
{
    U32  bakc;
...
****************************************************************************/
void  GUI_FloodFill(U32 x0, U32 y0, U32 color)
{
...
FILL_UP:
    ...
    while(1)
    {
        ...
        if( GUI_CmpPoinU32(xx, yy, fcolor) == 0 )
        {
            /* 判断此点是否为终点，若是则退出此次循环 */
            for(i = xx0; i <= xx1; i++)     					// 查找此行是否有需填充点
            {
                if( GUI_CmpPoinU32(i, yy, fcolor) != 0 ) break;
            }
        ...
        if(down_no < DOWNP_N)
        {
            ...
            for(i = y0; i <= xx1; i++)
            {
                if( GUI_CmpPoinU32(i, yy - 1, fcolor) == 0 )	// 更新折点
                {
                    y0 = i;
                }
                else
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Arc4(U32 x, U32 y, U32 r, U8 angle, U32 color)
{
    int32  draw_x, draw_y;
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Arc(U32 x, U32 y, U32 r, U32 stangle, U32 endangle, U32 color)
{
...
* 说明：操作失败原因是指定地址超出有效范围。
****************************************************************************/
void  GUI_Pieslice(U32 x, U32 y, U32 r, U32 stangle, U32 endangle, U32 color)
{
    int32  draw_x, draw_y;					// 画图坐标变量
    int32  op_x, op_y;						// 操作坐标
    int32  op_2rr;							// 2*r*r值变量
