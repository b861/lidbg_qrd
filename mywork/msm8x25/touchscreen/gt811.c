...
static int goodix_init_panel(struct goodix_ts_data *ts)
{
    ...
    uint8_t config_info7[] =
    {
        ...
        0x20,0x20,0x10,0x10,0x0A,0x48,0x30,0x07,0x03,0x00,0x05,0x2c,0x01,0x00,0x02,0x00,
    ...
    uint8_t config_info8[] =
    {
        ...
        0x30,0x30,0x10,0x10,0x0A,0x48,0x30,0x07,0x03,0x00,0x05,0x2c,0x01,0x00,0x02,0x00,
...
if(xy_revert_en==1)
{
            ...
            input_report_abs(ts->input_dev, ABS_MT_POSITION_X, input_y*2);
            input_report_abs(ts->input_dev, ABS_MT_POSITION_Y, input_x*2);
...
static int __devinit goodix_ts_init(void)
{
    ...
    LIDBG_GET;
#endif
    printk("\n\n==in=GT811.KO=====512-300==========touch INFO===========futengfei\n");
	SOC_IO_Output(0, 27, 1);
