...
u8 Image_Config[5][11]={
					...
					{	0xe1,		0Xe9,	0xee,		0xf1,		0xf3,		0xf5,		0xf6,		0xf8,	        0xf9,		0xfb,		0xff,	}, //BRIGHTNESS ed
					{	0x20,		0x28,		0x38,		0x48,		0x53,        0x58,		0x68,		0x78	,	0x88,		0x98,		0x9f,},//CONTRAST 9f
					{	0x81,		0x96,		0xb9,		0xdf,		0xe7,		0xff,		0x0	,	0xa,		0x35,		0x63,		0x7f,},//HUE
					{	0x0,		0x15,		0x30,		0x45,		0x65,		0x95,		0x95,		0xa5	,	0xd5,		0xe0,		0xff,},//SHARPNESS
					{	0x0,		0x15,		0x30,		0x45,		0x65,		0x95,		0x95,		0xa5	,	0xd5,		0xe0,		0xff,},//SHARPNESS
					   };
...
u8 Image_Config_AUX_BACK[5][11]={
					...
					{	0xff,		0x0,		0x10,		0x20,		0x30,		0x40,		0x45,		0x50	,	0x55,		0x60,		0x65,},//HUE
					{	0x0,		0x15,		0x30,		0x45,		0x65,		0x95,		0x95,		0xa5	,	0xd5,		0xe0,		0xff,},//SHARPNESS
					{	0x0,		0x15,		0x30,		0x45,		0x65,		0x95,		0x95,		0xa5	,	0xd5,		0xe0,		0xff,},//SHARPNESS
					   };
		...
		switch (cmd)
			{
				...
				case CONTRAST ://ok
					...
					{
						Tw9912_image[1]=Image_Config_AUX_BACK[1][10-valu];
						Tw9912_image_global_AUX_BACK[1][1]=Image_Config_AUX_BACK[1][10-valu];
					}
					ret = write_tw9912(&Tw9912_image);
					break;
				case HUE ://bad
			...
			switch (cmd)
			{
				...
				case CONTRAST ://ok
					...
					//if(global_video_format_flag = NTSC_I)
					{
						...
						Tw9912_image_global[1][1]=Image_Config[1][10-valu];
					}
					ret = write_tw9912(&Tw9912_image);
					break;
				case HUE ://bad
