...
namespace android
{
    ...
    private:
        ...
        bool supportVideoSizeOfHFR(const QCameraParameters &params);
        void changeUIOnCreate(const QCameraParameters &params);
        void changeUI(const QCameraParameters &params);
        ...
        status_t setPipMode(const QCameraParameters &params);
        ...
        status_t setExtModeValue(const QCameraParameters &params);
        status_t setMagicLensParam(const QCameraParameters &params);
        status_t setPipParam(const QCameraParameters &params);
        ...
        void deinitExifData();
        void setExifTagsGPS();
        exif_tags_info_t *getExifData()
        {
            return mExifData;
        }
        int getExifTableNumEntries()
        {
            return mExifTableNumEntries;
        }
        ...
        uint16_t mActualSensorWidth;
        uint16_t mActualSensorHeight;
        bool mCaptureScalingUp;
        bool mCameraResolutionUpSupport;
        uint16_t mSensorFakeWidth;
        uint16_t mSensorFakeHeight;
        uint16_t mUISetCameraWidth;
        uint16_t mUISetCameraHeight;
        ...
        QCameraHalHeap_t     mScalingUpMemory;
