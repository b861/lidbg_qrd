...
namespace android
{
    ...
    public:
        ...
        virtual sp<IMemoryHeap> getHeap() const
        {
            return NULL;
        }
        virtual status_t    initDisplayBuffers()
        {
            return NO_ERROR;
        }
        virtual status_t initPreviewOnlyBuffers()
        {
            return NO_ERROR;
        }
        ...
        virtual void *getLastQueuedFrame(void)
        {
            return NULL;
        }
        virtual status_t takePictureZSL(void)
        {
            return NO_ERROR;
        }
        ...
        virtual int setPreviewWindow(preview_stream_ops_t *window)
        {
            return NO_ERROR;
        }
    ...
    */
    ...
    private:
        ...
        mm_cameara_stream_buf_t mScalingUpStreamBuf;
